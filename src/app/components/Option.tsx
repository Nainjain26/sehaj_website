...
const Option = () => {
  return (
    <div className="mt-10  bg-blue-50">
        <h1 className="text-center text-3xl md:text-4xl font-semibold underline md:pt-10 decoration-blue-500 decoration-4 underline-offset-6 leading-tight">Our Services</h1>
     ...
     <p className="text-center text-xl pb-10 md:text-2xl transition-all hover:scale-105 duration-150 md:mb-11 "> <Link href={"/pricing"} className="mx-auto border p-3 rounded-2xl bg-blue-500 text-white  hover:bg-blue-600 "> Know More  </Link></p>
    </div>
  );
};
