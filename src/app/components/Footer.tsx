        ...
        <div className="">
          {/* <div className="flex items-center">
            <img
              src="/Frame 2.svg"
              alt=""
              className="h-[70px] w-[70px] mr-5"
            /> */}
            <h1 className="text-xl md:text-3xl font-semibold ">
              sahajresearchservices.com
            </h1>
          {/* </div> */}
          ...
          <div className="py-10 text-gray-700 md:text-xl">
            ...
            <div className="flex ">
              <p className="mr-2 text-xl md:text-2xl text-blue-600">
                {<IoMdMailUnread />}
              </p>
              <h1>
            ...
            <div className="flex">
              ...
              <h1>
                ...
                Correspondence Address 6th Floor,Unit no. 611, Princess Business
          ...
          <div>
            <h1 className="md:text-xl text-gray-700">
              ...
              <h1 className="mb-5">
                Toll Free investor Helpline: 1800 22 75 7575
              </h1>
            </h1>
          </div>
        </div>
        <div>
          <h1 className=" text-xl md:text-3xl font-semibold items-center">Quick Links</h1>
          <div className="py-5 md:text-xl text-gray-700">
            <p className=" hover:text-blue-400">
              <Link href={"/"}>Home</Link>
            </p>
            <p className=" pt-1 md:pt-3  hover:text-blue-400">
              <Link href={"/"}>Commodity</Link>
            </p>
            <p className=" pt-1 md:pt-3  hover:text-blue-400">
              <Link href={"/"}>Equity</Link>
            </p>
            <p className=" pt-1 md:pt-3  hover:text-blue-400">
              <Link href={"/Bank-details"}>Bank Details</Link>
            </p>
        ...
        <div>
          ...
          <div className="py-5">
            <iframe
              ...
              allowFullScreen
              loading="lazy"
              className="md:w-[350px] md:h-[350px] h-[250px] w-[250px]"
            />
            <h1 className="py-3 font-semibold text-xl md:text-2xl">
              Get In Touch
            </h1>
            <div className="flex">
