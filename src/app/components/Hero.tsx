  ...
  return (
    <div className=" md:grid grid-cols-2  items-center relative z-[1000]  ">
     ...
     <div className="h-[800px] w-[500px] max-md:hidden  z-[-1000]" >
      <Spline scene='https://prod.spline.design/sHwURiWMH0BuNdal/scene.splinecode'className="absolute " ></Spline>
    </div>
    {/* https://prod.spline.design/sHwURiWMH0BuNdal/scene.splinecode */}
      <motion.div 
